...
const App = () => {
  ...
  const [numberFilter, setNumberFilter] = useState(state.numberFilter); // Доданий стан для номера
...
const handleNumberFilterChange = e => {
 ...
 const filteredContacts = contacts.filter(contact => {
   ...
   const numberMatch = contact.number.includes(numberFilter); // Додана фільтрація за номером
